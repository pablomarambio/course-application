...
scenario 'control panel links' do
  visit upmin_path
  expect(page).to have_link("Upload students", :href=>"/admin/students/upload")
  expect(page).to have_link("Upload courses", :href=>"/admin/courses/upload")
  expect(page).to have_link("Upload results", :href=>"/admin/results/upload")
