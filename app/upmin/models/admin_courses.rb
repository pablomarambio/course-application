class AdminCourse < Upmin::Model
   # The attributes method overwrites default attributes shown for a model, and replaces them with the provided attributes.
   #These don't all need to be editable, but as long as there is an :attr_name= method available upmin assumes that the attribute should be editable.
  attributes :name, :classroom, :block_id,  :capacity, :course_batch_id
